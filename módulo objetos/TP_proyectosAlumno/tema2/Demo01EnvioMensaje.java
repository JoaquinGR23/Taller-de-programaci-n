...
public class Demo01EnvioMensaje {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(saludo1.toUpperCase().equals("HOLA")); /* al objeto string le envio un mensaje, -
        se ejecuta el metodo toUpperCase() y devuelve otro string, ese objeto con el nuevo valor le envio -
        un mensaje y se compara su contenido con el valor "HOLA" y retorna un booleano.  Imprime true */
